function [ xcurr Pcurr ] = ekf_step ( xprev, Pprev, uprev, ucurr, z, plant_param, filter_param)

%% Prediction

% compute new x
xpred = suspension_f_dics_euler( xprev, uprev, [ 0; 0 ], plant_param, filter_param);

F = suspension_Fk(xprev, plant_param, filter_param);
D = suspension_Dk(plant_param, filter_param);
...
H = suspension_Hk(xpred, plant_param);
M = suspension_Mk();
